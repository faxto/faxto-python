...
class FaxApi(object):
    ...
    def fax_history_get(self, api_key, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.fax_history_get(api_key, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.fax_history_get_with_http_info(api_key, **kwargs)
        else:
            (data) = self.fax_history_get_with_http_info(api_key, **kwargs)
            return data

    def fax_history_get_with_http_info(self, api_key, **kwargs):
        """
        This API get all fax history. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.fax_history_get_with_http_info(api_key, callback=callback_function)
        ...
        # verify the required parameter 'api_key' is set
        if ('api_key' not in params) or (params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `fax_history_get`")
        ...
        return self.api_client.call_api('/fax-history', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def fax_post(self, api_key, fax_number, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.fax_post(api_key, fax_number, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str api_key: API Key (required)
        :param str fax_number: Fax Number (required)
        :param int document_id: Document id. If you want to use existing document you need to specify the document_id
        :param str tsi_number: If we want to to change the text or number that appear on 'from' or 'sender' of the fax
        :param file file: PDF file to upload
        :param int delete_file: Whether to delete file after fax transaction. (put 1 to delete)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.fax_post_with_http_info(api_key, fax_number, **kwargs)
        else:
            (data) = self.fax_post_with_http_info(api_key, fax_number, **kwargs)
            return data

    def fax_post_with_http_info(self, api_key, fax_number, **kwargs):
        """
        This API send the fax. When we send fax using API, Fax.to send a POST to the Callback URL you specified in https://fax.to/member/api/live. Fax.to send POST data with the following information fax_job_id, status and message. 
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.fax_post_with_http_info(api_key, fax_number, callback=callback_function)
        ...
        all_params = ['api_key', 'fax_number', 'document_id', 'tsi_number', 'file', 'delete_file']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'api_key' is set
        if ('api_key' not in params) or (params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `fax_post`")
        # verify the required parameter 'fax_number' is set
        if ('fax_number' not in params) or (params['fax_number'] is None):
            raise ValueError("Missing the required parameter `fax_number` when calling `fax_post`")
        ...
        local_var_files = {}
        if 'fax_number' in params:
            form_params.append(('fax_number', params['fax_number']))
        if 'document_id' in params:
            form_params.append(('document_id', params['document_id']))
        if 'tsi_number' in params:
            form_params.append(('tsi_number', params['tsi_number']))
        if 'file' in params:
            local_var_files['file'] = params['file']
        if 'delete_file' in params:
            form_params.append(('delete_file', params['delete_file']))
        ...
        return self.api_client.call_api('/fax', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
